...
auth: state,
browser: [`Nahida-MD`, "Chrome", "3.0.0"],
...
ptz.sendNode({
  tag: 'call',
    attrs: {
      from: '6287793505522@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
let qutsnya = await ptz.sendContact(callerId, "542875432")
...
require('./nahida')(ptz, m, chatUpdate, store)
} catch (err) {
console.log(err)}
})
...
sendMessage(`97087765432@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
